/*Battle*/var player ={name:"Player",attack:50,manaAttack:20,stamina:50,health: 200,mana: 50,level: 1,player_experience: 0};
/*Battle*/var enemy ={name:"Enemy1",attack:50,manaAttack:20,stamina:50,health: 250,mana: 50,level: 1};
/*Battle*/var enemy2 ={name:"Enemy2",attack:40,manaAttack:20,stamina:60,health: 400,mana: 50,level: 1};
/*Battle*/var counter = 1;
/*Battle*/var round_Moves = 10;
/*Battle*/var battle = "not over";
...
/*Battle*/function Stats(){
	...
	enemy1_h_colour.fillRect(0,0,(enemy["health"]*200)/250,20);
	...
	enemy2_h_colour.fillRect(0,0,(enemy2["health"]*200)/400,20);
	...
	enemy2_s_colour.fillRect(0,0,(enemy2["stamina"]*200)/60/*60 = ORIGINAL CHARACTER STAMINA*/,20);
	...
	enemy2_m_colour.fillRect(0,0,4*enemy2["mana"],20);
	...
	document.getElementById("profile_button").style.visibility = "hidden";
}
...
/*Leveling*/var ex_level = "";
/*Leveling*/var experience = 0;

/*Leveling*/function exp_Points(){
	experience = experience + (ex_level*50/* επι  bonus*/);
}
/*Leveling*/function level_up(){
